...
== 0.8.7 December 10, 2019 ==
* Fixed sticky header

== 0.8.6 December 10, 2019 ==
* Moved post bundle
...
== 0.7.20 September 15, 2017 ==
* Exclude single posts from "subscriber-only" `pre_get_posts` action.
* Consolidated `pre_get_posts` actions
